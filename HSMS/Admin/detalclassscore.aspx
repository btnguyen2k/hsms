<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="detalclassscore.aspx.cs" Inherits="HSMS.Admin.detalclassscore" %>
...
<body>
    ...
    <div>
        <div>
            ...
            <center>
                <asp:Label ID="ResultContent" runat="server" ForeColor="Red" Width="522px"></asp:Label><br />
                <br />
                <asp:Table ID="ClassListTable" runat="server" BorderStyle="Solid" GridLines="Both"
                    Visible="False" Width="783px">
            ...
            <center>
                <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="Blue" NavigateUrl="~/Admin/detalclassscore.aspx"
                    Target="content_admin" Width="56px">Quay lại</asp:HyperLink>
            </center>
        </div>
