...
<body>
    ...
    <div>
        ...
        <asp:HyperLink ID="HyperLink5" runat="server" ForeColor="Blue" NavigateUrl="~/SanTruong.aspx"
            Target="content_pupil" Width="138px">* Khuông viên trường</asp:HyperLink><br />
